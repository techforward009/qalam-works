...
export const translations = {
  en: {
    ...
    cleanerTool: {
      ...
      description: "Upload a .txt or .docx file to clean spacing and apply language-aware normalization — Urdu, English, or Arabic-safe — then download the result. Processing stays in your browser.",
      languageLabel: "Text language",
      languageHint: "Auto uses safe cleanup only when script language is uncertain. Choose Urdu or Arabic for language-specific fixes. English mode never converts punctuation to Arabic forms.",
      langAuto: "Auto",
      langUrdu: "Urdu",
      langEnglish: "English",
      langArabic: "Arabic",
  ...
  ur: {
    ...
    cleanerTool: {
      title: "ڈاکومنٹ کلینر",
      description: ".txt یا .docx فائل اپلوڈ کریں۔ متن کی زبان کے مطابق صفائی اور معیاری کاری لگائیں — اردو، انگریزی، یا عربی محفوظ موڈ — پھر فائل ڈاؤن لوڈ کریں۔ تمام کارروائی براؤزر میں ہوتی ہے۔",
      languageLabel: "متن کی زبان",
      languageHint: "آٹو غیر یقینی رسم الخط پر صرف محفوظ صفائی کرتا ہے۔ مخصوص اصلاح کے لیے اردو یا عربی منتخب کریں۔ انگریزی موڈ رموز اوقاف کو عربی شکل میں نہیں بدلتا۔",
      langAuto: "آٹو",
      langUrdu: "اردو",
      langEnglish: "انگریزی",
      langArabic: "عربی",
