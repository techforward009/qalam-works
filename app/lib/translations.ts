...
export const translations = {
  ...
  ur: {
    ...
    about: {
      ...
      body1: "قلم ورکس ان لکھاریوں، مترجمین، محققین، ناشرین، اور تعلیمی اداروں کے لیے بنایا گیا ہے جو اردو دستاویزات کے ساتھ سنجیدگی سے کام کرتے ہیں۔ ہمارے ٹولز درستگی، Unicode یکسانیت، صاف typography، اور اشاعت کے معیار کے output پر توجہ دیتے ہیں۔",
      ...
      servicesBody: "خود کار ٹولز کے علاوہ، قلم ورکس پیشہ ورانہ لسانی خدمات بھی فراہم کرتا ہے، جن میں ترجمہ (اردو، انگریزی، عربی، فارسی)، اردو proofreading، اور اشاعت کے لیے دستاویز فارمیٹنگ شامل ہیں۔",
      ctaLabel: "رابطہ کریں",
    },
    servicesPage: {
      ...
      proofItems: [
        "اردو proofreading اور لسانی تدوین",
    ...
    contactPage: {
      heading: "رابطہ",
      body: "ترجمہ، تدوین، proofreading، یا اشاعتی خدمات کے لیے — یا ہمارے کسی ٹول کے بارے میں سوال کے لیے — ہمیں ای میل بھیجیں۔",
      emailLabel: "ای میل",
    ...
    privacyPage: {
      ...
      sections: [
        ...
        { title: "مقامی ذخیرہ", body: "ڈاکومنٹ اسٹوڈیو آپ کا مسودہ آپ کے براؤزر کے localStorage میں محفوظ کرتا ہے۔ یہ ڈیٹا کبھی آپ کے آلے سے باہر نہیں جاتا۔" },
        ...
        { title: "Cookies اور Analytics", body: "ہم ٹریکنگ cookies یا تھرڈ پارٹی analytics استعمال نہیں کرتے۔" },
