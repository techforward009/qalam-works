...
export const translations = {
  en: {
    ...
    jobGuidance: {
      ...
      items: [
        {
          label: "My text broke after copy-paste",
          href: "/tools/document-cleaner",
          description: "Document Cleaner",
          body: "Clean spacing, punctuation and formatting issues.",
        },
        {
          label: "My Urdu letters appear in mixed forms",
          href: "/tools/unicode-standardizer",
          description: "Urdu Unicode Standardizer",
          body: "Normalize Urdu character forms and Unicode variants.",
        },
        {
          label: "I need to prepare a full document",
          href: "/tools/document-studio",
          description: "Document Studio",
          body: "Write, edit, audit and export publication-ready documents.",
        },
        {
          label: "Urdu and English must display correctly on WhatsApp",
          href: "/tools/whatsapp-rtl-formatter",
          description: "WhatsApp RTL Formatter",
          body: "Prepare mixed Urdu and English text for stable WhatsApp direction.",
        },
      ],
    },
    whoItsFor: {
    ...
    cleanerTool: {
      ...
      languageHint: "Choose a language mode for the most accurate cleanup. Auto uses safe cleanup only when script language is uncertain. Choose Urdu or Arabic for language-specific fixes. English mode never converts punctuation to Arabic forms.",
      langAuto: "Auto",
      langUrdu: "Urdu",
      langEnglish: "English",
      langArabic: "Arabic",
  ...
  ur: {
    ...
    jobGuidance: {
      ...
      items: [
        {
          label: "میرا متن copy کرنے کے بعد خراب ہو گیا ہے",
          href: "/tools/document-cleaner",
          description: "ڈاکومنٹ کلینر",
          body: "فاصلہ، رموز اوقاف اور فارمیٹنگ کے مسائل صاف کریں۔",
        },
        {
          label: "میرے اردو حروف مختلف شکلوں میں آ گئے ہیں",
          href: "/tools/unicode-standardizer",
          description: "اردو یونیکوڈ اسٹینڈرڈائزر",
          body: "اردو حروف کی شکلیں اور یونیکوڈ ویرینٹس معیاری بنائیں۔",
        },
        {
          label: "مجھے مکمل document تیار کرنا ہے",
          href: "/tools/document-studio",
          description: "ڈاکومنٹ اسٹوڈیو",
          body: "لکھیں، تدوین کریں، جائزہ لیں اور اشاعت کے لیے ایکسپورٹ کریں۔",
        },
        {
          label: "WhatsApp پر اردو اور English صحیح دکھانی ہے",
          href: "/tools/whatsapp-rtl-formatter",
          description: "واٹس ایپ آر ٹی ایل فارمیٹر",
          body: "مخلوط اردو اور انگریزی متن کو واٹس ایپ کے لیے مستحکم سمت میں تیار کریں۔",
        },
      ],
    },
    whoItsFor: {
    ...
    cleanerTool: {
      ...
      languageHint: "درست صفائی کے لیے زبان کا موڈ منتخب کریں۔ آٹو غیر یقینی رسم الخط پر صرف محفوظ صفائی کرتا ہے۔ مخصوص اصلاح کے لیے اردو یا عربی منتخب کریں۔ انگریزی موڈ رموز اوقاف کو عربی شکل میں نہیں بدلتا۔",
      langAuto: "آٹو",
      langUrdu: "اردو",
      langEnglish: "انگریزی",
      langArabic: "عربی",
