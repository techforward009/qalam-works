      ...
      items: [
        {
          ...
          body: "PDF، ویب یا مختلف sources سے copy کیے گئے متن کو صاف کریں۔",
        },
        {
          label: "حروف کی اصلاح",
          href: "/tools/unicode-standardizer",
        ...
        {
          label: "مکمل دستاویز کا کام",
          href: "/tools/document-studio",
          description: "ڈاکومنٹ اسٹوڈیو",
          body: "Edit، standardize، review اور export کے لیے مکمل workspace۔",
        },
        {
          label: "اشاعت سے پہلے جانچ",
          href: "/tools/quality-checker",
          description: "کوالٹی آڈٹ",
          body: "اپنے متن کے مسائل تلاش کریں اور بہتر بنانے کے لیے اگلا قدم لیں۔",
        },
      ],
    },
    whoItsFor: {
