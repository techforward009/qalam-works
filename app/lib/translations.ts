...
export const translations = {
  en: {
    ...
    cleanerTool: {
      ...
      languageHint: "Auto is conservative. Choose Arabic explicitly to preserve ي/ك. English mode never converts punctuation to Arabic forms.",
      langAuto: "Auto",
      langUrdu: "Urdu",
      langEnglish: "English",
      langArabic: "Arabic",
  ...
  ur: {
    ...
    cleanerTool: {
      ...
      languageHint: "آٹو محتاط ہے۔ عربی ي/ك محفوظ رکھنے کے لیے عربی موڈ منتخب کریں۔ انگریزی موڈ رموز اوقاف کو عربی شکل میں نہیں بدلتا۔",
      langAuto: "آٹو",
      langUrdu: "اردو",
      langEnglish: "انگریزی",
      langArabic: "عربی",
