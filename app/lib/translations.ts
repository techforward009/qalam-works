...
export const translations = {
  en: {
    ...
    jobGuidance: {
      ...
      items: [
        ...
        {
          label: "Fix Urdu character forms",
    ...
    cleanerTool: {
      ...
      exampleNextHint: "Review the example, then click Clean Text to process.",
  ...
  ur: {
    ...
    cleanerTool: {
      ...
      exampleNextHint: "مثال دیکھیں، پھر صفائی کے لیے «متن صاف کریں» دبائیں۔",
