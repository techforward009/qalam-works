...
const L = {
  en: {
    ...
    sunday: "Sunday",
    monday: "Monday",
    hijriApplyTo: "Monthly Hijri adjustments",
    ...
    sightingHelp: "Save or load this year's twelve monthly Hijri offsets. Open an archive later, or edit it here if the sighting is later confirmed differently.",
  ...
  ur: {
    ...
    sunday: "اتوار",
    monday: "پیر",
    hijriApplyTo: "ماہانہ ہجری تبدیلیاں",
    ...
    sightingHelp: "اس سال کی بارہ ماہانہ ہجری تبدیلیاں محفوظ یا لوڈ کریں۔ بعد میں آرکائیو کھولیں، یا اگر رؤیت بدل جائے تو یہیں درست کریں۔",
...
export default function CalendarMakerContent() {
  ...
  }, [validYear, content, calendarLanguage, effectiveWeekStart, page, hijriOffsets]);
